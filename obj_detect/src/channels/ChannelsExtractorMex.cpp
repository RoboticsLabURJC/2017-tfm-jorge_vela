...
/*****************************************************************************************************/
 ...
 float* ChannelsMexExtractor::allocW(int size , int sf, int misalign){
 	float *var;
 	var  = (float*) wrCalloc(size+misalign,sf) + misalign;
 	return var;
 }

 void ChannelsMexExtractor::gradM(float *I, float *M, float *O){
	const int h=12, w=12  , misalign=1; int x, y, d=3; //192   const int h=12, w=12,
